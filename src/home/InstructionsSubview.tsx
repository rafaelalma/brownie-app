    ...
    <>
      ...
      <Container>
        ...
        <Typography variant="body2" gutterBottom>
          ...
          perros. El cambio de ser “voluntario nuevo” a “veterano” depende de
          las valoraciones de los compañeros que van con el voluntario nuevo de
          turno.
        </Typography>
        <Typography variant="body2" gutterBottom>
        ...
        <Typography variant="body2" gutterBottom>
          Una vez que el voluntario nuevo tenga varias valoraciones positivas,
          la coordinadora se lo hará saber y, en caso de que el voluntario se
          vea preparado para ser veterano, pasará de ser “nuevo” a “veterano” y
          se anunciará por el grupo de Whatsapp “Guardería”.
        </Typography>
        <Divider variant="middle" sx={dividerStyles} />
        <Typography variant="body1" fontWeight={500} gutterBottom>
          Cuadrante
        ...
        <Typography variant="body2" gutterBottom>
          ...
          <strong>NO</strong> se toca y quien no se haya apuntado no va de
          turno.
        </Typography>
        <Typography variant="body2" gutterBottom>
          Si durante la semana <strong>NO</strong> podéis ir al turno elegido,
          debéis <strong>avisar</strong> por el grupo “Chorras de Guardería”
          para que los compañeros del turno lo sepan y pueda salir alguien que
          cubra el turno.
        </Typography>
        <Typography variant="body2" gutterBottom>
          ...
          baja si se tienen{' '}
          <strong>muchas faltas pero no son continuadas</strong>. Necesitamos
          voluntarios que puedan ir regularmente, no tres veces cada dos meses.
        </Typography>
        <Typography variant="body2" gutterBottom>
        ...
        <Typography variant="body2" gutterBottom>
          El cuadrante se abre a <strong>tres voluntarios por turno</strong>,
          una vez se hayan completado todos se abrirá a cuatro, y así
          sucesivamente.
        </Typography>
        <ol>
          <li>
            <Typography variant="body2">
              ...
              <strong>NO</strong> modifican nada. El cuadrante en sí solo lo
              toca la coordinadora
            </Typography>
          </li>
          <li>
            <Typography variant="body2">
          ...
          <li>
            <Typography variant="body2">
              <strong>
                Voluntarios para ir de turno / que tienen varios días
                disponibles
              </strong>
              : Aquí <strong>SÍ</strong> se apuntan los voluntarios. El
              voluntario debe poner su nombre y, entre paréntesis, si es nuevo +
              su disponibilidad
            </Typography>
            <ol style={nestedListStyle}>
              <li>
                <Typography variant="body2">
                  Ejemplo: Laura G (nueva, martes mañana) / Laura G (viernes
                  tarde y sábado mañana)
                </Typography>
              </li>
              <li>
                <Typography variant="body2">
                  Se debe especificar bien qué turnos elige el voluntario para
                  que no haya confusión
                </Typography>
              </li>
              <li>
                <Typography variant="body2">
                  Si al apuntarse ya hay otros voluntarios apuntados antes que
                  él para el mismo día y se llega con ellos al máximo por turno
                  (tres voluntarios) y el cuadrante no se abre a cuatro, dicho
          ...
          <li>
            <Typography variant="body2">
              ...
              <strong>NO</strong> se toca. Aquí se apuntan en rojo los
              voluntarios que ni se apuntan en el cuadrante ni van de turno
            </Typography>
          </li>
        </ol>
        <Typography variant="body2" gutterBottom>
        ...
        <Typography variant="body2" gutterBottom>
          <WarningColor>Naranja</WarningColor>: Salen los perros pero haría
          falta una persona más
          <br />
          <ErrorColor>Rojo</ErrorColor>: <strong>NO</strong> hay turno, los
          perros NO salen
          <br />
        ...
        <Typography variant="body2" gutterBottom>
          ...
          difundir en España, los perros pre reservados se pueden enseñar
          avisando antes a la coordinadora para que os diga en qué situación se
          encuentra el perro.
        </Typography>
        <Typography variant="body2" gutterBottom>
          <strong>NO</strong> se sacan perros de la jaula ni de patio para que
          los vean, las familias <strong>NO</strong> pueden entrar a patio{' '}
          <strong>NI</strong> a las jaulas.
        </Typography>
        <Typography variant="body2" gutterBottom>
          Si una familia se interesa en un perro se les indica que deben
          escribir al email del Módulo (
          <Link
        ...
        <Typography variant="body2" gutterBottom>
          En listado aparecen todos los perros con su edad, peso, tamaño,
          posible enfermedad… Todo lo que necesitáis saber está ahí reflejado.
        </Typography>
        <Typography variant="body2" gutterBottom>
          Si la familia en cuestión quiere ver perros de otros Módulos, se busca
          a un voluntario de dicho Módulo, <strong>NO</strong> enseñamos perros
          que no son de nuestro Módulo.
        </Typography>
        <Typography variant="body2" gutterBottom>
        ...
        <Typography variant="body2" gutterBottom>
          Las familias <strong>NO</strong> pueden entrar al D por detrás ni
          estar solos en nuestro pasillo. Si solo hay un voluntario de turno y
          no le puede enseñar los perros, se les remite al email y se les dará
          cita otro día.
        </Typography>
        <Typography variant="body2" gutterBottom>
          Proceso de adopción:
        ...
        <Typography variant="body2" gutterBottom>
          <strong>NO</strong> os dejéis engañar si aparecen familias diciendo
          que tenían cita con tal persona, que habían rellenado cuestionario
          pero no les contestan, si quieren ver a tal perro fuera de la jaula…
          La coordinadora siempre os avisará de todo.
        </Typography>
        <Typography variant="body2" gutterBottom>
          El email está actualizado las 24h del día, pero siempre recordad que
          somos voluntarios, no máquinas, y que, si una vez tardamos en
          contestar un día, es normal.
        </Typography>
        <Typography variant="body2" gutterBottom>
        ...
        <ul>
          ...
          <li>
            <Typography variant="body2">
              Seguimiento del animal una vez adoptado{' '}
              <strong>OBLIGATORIO</strong> (llamadas + fotos WhatsApp + visitas
              al domicilio)
            </Typography>
          </li>
        </ul>
        <Typography variant="body2" gutterBottom>
          En caso de que el perro fuese un PPP necesitaría, además, licencia
          para la tenencia de perros potencialmente peligrosos y un seguro de
        ...
        <Typography variant="body2" gutterBottom>
          A medida que los voluntarios van siendo veteranos entran en el grupo
          de seguimientos.
        </Typography>
        <Typography variant="body2" gutterBottom>
          Una vez que los perros se van adoptados en Málaga, al par de días un
          voluntario contacta con la familia adoptante para comprobar que todo
          va bien y que le manden fotos del perro en cuestión. Básicamente, los
        ...
        <Typography variant="body2" gutterBottom>
          Sólo lo modifica la coordinadora para evitar errores que perjudiquen
        ...
        <ul>
          ...
          <li>
            <Typography variant="body2">
              ...
              para ver el tamaño del perro, sentados, primer plano, sin que
              salga el voluntario con fondo bonito (plantas, muro patio
              cachorros, en paseo…)
            </Typography>
          </li>
        </ul>
        ...
        <List dense>
          <ListItem>
            ...
            <ListItemText primaryTypographyProps={{ variant: 'body2' }}>
              <strong>NO</strong> se sacan perros a clínica sin avisar antes a
              la coordinadora, ya que se han podido sacar en otro turno, que se
              les pase a los voluntarios, y que las auxiliares y veterinarias
              pierdan el tiempo revisando de nuevo a un perro que ya se revisó
            </ListItemText>
          </ListItem>
          <ListItem>
            <ListItemIcon>
            ...
            <ListItemText primaryTypographyProps={{ variant: 'body2' }}>
              ...
              los Trabajadores, si os mandan hacer algo que la coordinadora no
              ha dicho, se le avisa y lo hacéis, ella se encargará de hablar con
          ...
          <ListItem>
            ...
            <ListItemText primaryTypographyProps={{ variant: 'body2' }}>
              El usuario y contraseña de acceso a la App serán proporcionadas
              por la coordinadora
            </ListItemText>
          </ListItem>
        </List>
